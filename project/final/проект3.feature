...
проверить проведелние документа Продажи 
чтобы убедиться в работе программы

Контекст:
	Дано Я открыл новый сеанс TestClient или подключил уже существующий
	
Сценарий: _01 Открытие формы документа Продажи
	И я закрываю все окна клиентского приложения
	И В командном интерфейсе я выбираю 'Продажи' 'Продажи'
	И я нажимаю на кнопку с именем 'ФормаСоздать'

Сценарий: _02 Заполнение шапки формы документа Продажи
	* Организация
	...
	* Покупатель
		...
		И значение поля "Покупатель" содержит текст 'Магазин "Продукты"'
		И я удаляю переменную 'Покупатель'
		И я запоминаю значение поля "Покупатель" как "$$Покупатель$$"
	* Склад
		И из выпадающего списка с именем "Склад" я выбираю точное значение 'Большой'
		И значение поля "Склад" содержит текст 'Большой'
...
Сценарий: _03 Заполнение шапки формы документа Продажи валюта
	* Организация
...
Сценарий: _04 Заполнение табличной части документа Продажи 
...
Сценарий: _05 Проведение документа
	И я закрываю все окна клиентского приложения
...
Сценарий: _06 Проверка печатной формы Печать расходной накладной
...
Сценарий: _07 Проверка печатной формы заявка на доставку 				
...
Сценарий: _08 Проверка движени по регистру взаиморасчетов с контрагентами				
...
Сценарий: _09 Проверка движени по регистру взаиморасчетов с контрагентами
...
Сценарий: _10 Проверка движени по регистру товарных запасов
